...
const AccountPage = ({ children }: { children: React.ReactNode }) => {
  ...
  const activeTab = pathname.split('/').pop() || "my-profile";
  ...
  return (
    <div className="container mx-auto px-4 lg:px-0 mb-[37px] mt-10 ">
              ...
              return (
                <li
                  ...
                  className={`flex items-center h-[42px] gap-3 py-2 px-4 rounded-md cursor-pointer text-sm font-medium transition-colors duration-200 ${isActive
                      ? "bg-black  dark:text-white border-gray-300 text-white"
                      : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 border-gray-300"
                    }`}
                >
