      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Counter
            ...
            onIncrement={() =>
              setFormData((p: any) => ({ ...p, hours: (p.hours || 0) + 1 }))
            }
            onDecrement={() =>
              setFormData((p: any) => ({
                ...p,
                hours: Math.max(1, (p.hours || 0) - 1),
              }))
            }
          />
          ...
          <Counter
            ...
            onIncrement={() =>
              setFormData((p: any) => ({
                ...p,
                minutes: Math.min(59, (p.minutes || 0) + 15),
              }))
            }
            onDecrement={() =>
              setFormData((p: any) => ({
                ...p,
                minutes: Math.max(0, (p.minutes || 0) - 15),
              }))
            }
          />
        </div>
...
export default PriceHourlyForm;