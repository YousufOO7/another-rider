...
import PriceHourlyForm from "./PriceHourlyForm";
...
type Props = {
  ...
  passengers: {
    ...
    onShowPriceWhereAndWhen?: () => void; // নতুন প্রপ
  onBack?: () => void; // ব্যাক বাটনের জন্য
  isFromPriceQuote?: boolean;
  setFormData: React.Dispatch<React.SetStateAction<any>>;
};

const PriceWhereAndWhen = ({
  formData,
  onNext,
  pickup_address,
  dropoff_address,
...
useEffect(() => {
 ...
 // Extra stops add করার সময় distance update করুন
  ...
  return (
    ...
    <Button
      onClick={onBack}
      className="w-full md:w-38 mb-2 md:mb-0 cursor-pointer"
    >
      ← Back to Booking
    </Button>
  )}
...
export default PriceWhereAndWhen;