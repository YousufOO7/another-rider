...
const PriceSelectVehicle = ({ onBack, formData, setFormData }: Props) => {
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="flex justify-end  pb-5 p-2 md:p-6">
          <Button
            ...
            variant={"default"}
            onClick={handleNext}
            className={`px-5 py-2 text-sm font-medium cursor-pointer rounded-none
            ${
              formData.vehicle
                ? "bg-black text-white"
...
export default PriceSelectVehicle;